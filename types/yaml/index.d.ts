...
declare module "yaml/seq" {
  import YAML from "yaml";
  const SeqConstructor: YAML.ast.SeqConstructor;
  export default SeqConstructor;
}

declare module "yaml/map" {
  import YAML from "yaml";
  const MapConstructor: YAML.ast.MapConstructor;
...
declare module "yaml" {
  ...
  namespace YAML {
     ...
     */
    function stringify(value: any, options?: ParseOptions): string;
     ...
     */
    function parseDocument(str: string, options?: ParseOptions): ast.Document;
    ...
    interface YAMLWarning extends Error {
      name: "YAMLReferenceError";
      source: cst.Node;
    }
    ...
    namespace ast {
      ...
      interface Anchors {
         ...
         */
        setAnchor(node: Node, name?: string): void | string;
      }
